...
// 加载文章分类
import { getArticleCategoryList, getArticlesService, addArticleService, updateArticleService, deleteArticleService } from '@/api/article.js'
...
const uploadSuccess = (result) => {
    result.data = 'https://tse3-mm.cn.bing.net/th/id/OIP-C.C64i5Jj0CbEXYKp0h3CwJgHaE8?rs=1&pid=ImgDetMain'
    ...
    <el-card class="page-container">
        ...
        <el-table :data="articles" style="width: 100%">
            ...
            <el-table-column label="操作" width="100">
                <template #default="{ row }">
                    <el-button :icon="Edit" circle plain type="primary" @click="btnEditClick(row)"></el-button>
        ...
        <el-drawer v-model="visibleDrawer" :title="drawerTitle" direction="rtl" size="50%">
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item>
                    <el-button type="primary" @click="btnPublishClick('已发布')">发布</el-button>
                    <el-button type="info" @click="btnPublishClick('草稿')">草稿</el-button>
                </el-form-item>
            </el-form>
        </el-drawer>
    </el-card>
